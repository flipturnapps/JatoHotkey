...
public class InputKeeperHook extends Hook
{
	...
	@Override
	public void nativeKeyReleased(NativeKeyEvent e) { this.runModifications(e.getID(), true, false, false); }

	@Override
	public void nativeMousePressed(NativeMouseEvent e) { this.runModifications(e.getButton(), false, true, true); }

	@Override
	public void nativeMouseReleased(NativeMouseEvent e) { this.runModifications(e.getButton(), false, true, false); }
